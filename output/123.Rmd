...
## The Collaborative Filtering approach
Firstly, we use the "Cosine Similarity" Algorithm to compute the similarity between any two users.  
Then given User1,we find the most similar user and return the movies that are not viewed by User1.
